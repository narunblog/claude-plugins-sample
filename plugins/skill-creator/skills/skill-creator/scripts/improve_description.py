#!/usr/bin/env python3
"""評価結果に基づいてスキルdescriptionを改善する。

run_eval.pyの評価結果を受け取り、Claudeのextended thinkingを使って
改善されたdescriptionを生成する。
"""
...
def main():
    parser = argparse.ArgumentParser(description="評価結果に基づいてスキルdescriptionを改善する")
    ...
    parser.add_argument("--verbose", action="store_true", help="stderrにthinkingを出力")
    ...
    # 新しいdescriptionと更新された履歴をJSONで出力
    output = {
